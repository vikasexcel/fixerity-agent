                                        ...
                                        @if(isset($un_register_providers_list))
                                            @foreach($un_register_providers_list as $key => $un_register_providers)
                                                <tr id="delete_provider_{{$un_register_providers->id}}">
                                                    <td>{{ $key + 1 }}</td>
                                                    <td>
                                                        {{ ucwords($un_register_providers->first_name) . " " .ucwords($un_register_providers->last_name) }}
                                                    </td>
                                                    <td>
                                                        {{ App\Models\User::Email2Stars($un_register_providers->email) }}
                                                    </td><td>
                                                        {{ App\Models\User::ContactNumber2Stars($un_register_providers->country_code."".$un_register_providers->contact_number) }}
                                                    </td>
                                                    <td class="action">
