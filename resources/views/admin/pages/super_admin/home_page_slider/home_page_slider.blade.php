...
@section('title')
    @if(isset($home_banner)) Edit @else Add @endif Slider List
@endsection
@section('page-css')
                ...
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            ...
                            <span>@if(isset($home_banner)) Edit @else Add @endif Slider</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <a href="{{ route('get:admin:home_page_slider_list') }}"
        ...
        <div class="pcoded-inner-content">
            <div class="main-body">
                <div class="page-wrapper">
                    <!-- Page body start -->
                    <div class="page-body">
                        <form id="main" method="post" action="{{ route('post:admin:add_home_page_slider') }}"
