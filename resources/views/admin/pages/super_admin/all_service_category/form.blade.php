...
@section('title')
    @if(!isset($service_category))Add @else Edit @endif Service Category
@endsection
@section('page-css')
    <style>
                ...
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            ...
                            <span>@if(!isset($service_category))Add @else Edit @endif Service Category</span>
                        </div>
                    </div>
                </div>
                {{--<div class="col-lg-4">--}}
                    ...
                    <div class="page-body">
                        <div class="card">
                            <div class="card-header">
                                <h5>@if(!isset($service_category))Add @else Edit @endif Service Category</h5>
                                <a href="{{ (isset($service_category->category_type) && ($service_category->category_type == 1 || $service_category->category_type == 5 ) )? (($service_category->slug=="coupon-deals")?route('get:admin:coupon_deals_service_list'):route('get:admin:transport_service_list')):route('get:admin:store_service_list') }}"
                                   class="btn btn-primary m-b-0 btn-right"> Back</a>
                            </div>
                            <div class="card-block">
                                <form id="main" method="post" action="{{ route('post:admin:update_all_service_category') }}"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-8">
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">Category Name:<sup class="error">*</sup></label>
                                                <div class="col-sm-9">
                                            ...
                                            @if(isset($language_lists))
                                                ...
                                                @foreach($language_lists as $single_lang)
                                                    ...
                                                    @endphp
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 col-form-label">Category Name (in {{ $language_name }}):<sup class="error">*</sup></label>
                                                        <div class="col-sm-9">
