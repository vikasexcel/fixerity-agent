...
<!-- Style.css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/style.css?v=0.8')}}">
        ...
        <div class="pcoded-main-container">
            <div class="pcoded-wrapper">
                ...
                @if(Illuminate\Support\Facades\Auth::guard("admin")->check())
                    ...
                    @else
                        @if(Illuminate\Support\Facades\Auth::guard("admin")->user()->roles == 2)
                            <script>window.location = "{{route('get:dispatcher:manual_ride_booking')}}";</script>
                        @else
